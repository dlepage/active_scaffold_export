...
ActiveScaffold::Config::Core.class_eval do
  ...
  export_xlsx_avaliable = Gem::Specification::find_all_by_name('axlsx_rails').any?
  self.send :class_variable_set, :@@export_xlsx_avaliable, export_xlsx_avaliable
  self.send :class_variable_set, :@@export_default_file_format, export_xlsx_avaliable ? 'xlsx' : 'csv'
